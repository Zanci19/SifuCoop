...
// more ai comment coz i was too lazy to explain this myself
...
// Two-part message, so a packet's header and body can be signed without being copied into one buffer first
